  ...
  render() {
      ...
      return (
          ...
          <Menu theme="dark" onClick={this.handleClick} selectedKeys={[current]} mode="horizontal" style={{ float: 'right', zIndex: 99 }}>
              ...
              <SubMenu key="SubMenu" style={{ float: 'right' }} icon={ <Avatar src={this.state.userinfo ? this.state.userinfo.avatar : ''} />} title={this.state.userinfo ? this.state.userinfo.name : ''} >
